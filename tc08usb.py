...
class TC08USB(object):
    ...
    def get_minimum_interval(self):
        return(self._dll.usb_tc08_get_minimum_interval_ms(self.handle))
        
    def start_streaming(self):
        minimum_interval = self.get_minimum_interval()
        self._dll.usb_tc08_run(self._handle, minimum_interval)
        pass
